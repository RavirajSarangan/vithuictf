-- Idempotent A/L Past Papers folder template: root → 3 mediums → years 2011–2025
DO $$
DECLARE
  root_id UUID;
  medium_id UUID;
...
BEGIN
  ...
  WHERE slug = 'a-l-past-papers' AND parent_id IS NULL
  LIMIT 1;
  ...
  IF root_id IS NULL THEN
    INSERT INTO public.pass_paper_folders (
      ...
      'A/L Past Papers',
      'a-l-past-papers',
      'Advanced Level past papers organized by medium and year.',
      'graduation-cap',
      '#1e3a5f',
      'folder',
      0,
